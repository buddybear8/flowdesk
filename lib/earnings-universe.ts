// Earnings Analyst universe — beyond the platform's tracked tickers, include
// every S&P 500, Nasdaq-100, and Dow 30 name. S&P membership comes live from
// UW's earnings feed (`is_s_p_500` per event), so only the two smaller
// indices need static lists here. Constituents change a handful of times a
// year; update on rebalance announcements (last reviewed 2026-07).

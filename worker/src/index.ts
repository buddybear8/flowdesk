...
import { runFlowRetentionSweep, runDpRetentionSweep, runGexHeatmapRetentionSweep, runFlowSentimentRetentionSweep, runWatchesRetentionSweep, runPushDeviceRetentionSweep } from "./jobs/retention.js";
...
cron.schedule("0 0 3 * * 1-5", safe("retention-sweeps", async () => {
  ...
  await runPushDeviceRetentionSweep();
}));

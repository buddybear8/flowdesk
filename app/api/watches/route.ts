...
export async function GET(req: Request) {
  ...
  const items: HitListItem[] = hits.map((r) => ({
    ...
    ...(r.contractEntryPrice != null ? { contractEntryPrice: Number(r.contractEntryPrice) } : {}),
    ...(r.contractLastPrice != null ? { contractLivePrice: Number(r.contractLastPrice) } : {}),
    ...(r.contractMarkedAt ? { contractPriceAt: r.contractMarkedAt.toISOString() } : {}),

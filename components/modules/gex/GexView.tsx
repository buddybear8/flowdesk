...
const TICKERS = ["AAPL", "AMD", "AMZN", "APP", "ASTS", "BABA", "COIN", "DRAM", "ENPH", "GDX", "GLD", "GOOGL", "HOOD", "INTC", "META", "MRVL", "MSFT", "MU", "NBIS", "NFLX", "NOW", "NVDA", "ORCL", "PLTR", "QCOM", "QQQ", "SLV", "SMH", "SNDK", "SNOW", "SOXX", "SPCX", "SPX", "SPY", "TSLA", "VIX", "XBI", "XLE", "XLK"];
